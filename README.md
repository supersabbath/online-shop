...
Online shop prototype (front end) implemented using React, Redux, React router, and React Material UI library. I created this project mainly as a learning experience.  
